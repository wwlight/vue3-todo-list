<template>
    <div class="footer-wrapper">
        <el-checkbox
            ...
            @change="checkAllTodo"
        >全选</el-checkbox>
        <el-checkbox v-model="checked" border size="small" @change="reverseCheck">反选</el-checkbox>
        <el-alert
            :title="`已完成 ${$store.getters['todos/doneTodosLen']} / 全部 ${$store.getters['todos/todosLen']}`"
            type="info"
            :closable="false"
        />
        <el-button
